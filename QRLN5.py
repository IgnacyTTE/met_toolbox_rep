# -*- coding: utf-8 -*-
"""
Created on Tue Apr  9 14:00:12 2024
...
data_from = dt.date(data_to.year - 10, data_to.month, data_to.day)
function ='AVERAGE'
frequency ='D'
...
def draw_res_plots(areas, data_types):
    ...
    for ax, country_name in zip(axs, country_names):
        ...
        ax.bar(df_country['DateTime'], df_country['Anomaly'], width=0.01, label='Anomaly', color='blue', alpha=0.5)
